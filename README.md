...
**[Read the results write-up →](https://valofils.github.io/madagascar-stunting-sae/)**
&nbsp;·&nbsp; served by GitHub Pages from [`docs/index.html`](docs/index.html).
...
- **[Results write-up](https://valofils.github.io/madagascar-stunting-sae/)** — headline estimates, the paradox
  decomposition, comparison against the World Bank and IHME precedents, and the
  validation including what failed. Source: [`docs/index.html`](docs/index.html).
